class Runner extends Personaje {
    constructor() {
        ...
        this.elementoHTML = this.personaje; // Asegúrate de que esto esté definido
    }
    ...
    saltar() {
        if (this.personaje.classList.contains("correr")) {
            ...
            this.personaje.addEventListener("animationend", () => {
                this.caer();
            }, { once: true }); // Agregar { once: true } para que se elimine automáticamente después de la primera ejecución
        }
    }
